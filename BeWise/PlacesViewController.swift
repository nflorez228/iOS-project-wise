...
class PlacesViewController: UIViewController,UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    @IBOutlet weak var ppalimage: UIImageView!
    @IBOutlet weak var ppalimagesmall: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        ppalimage.blurImage()
        ppalimagesmall.layer.cornerRadius = ppalimagesmall.frame.size.width/2
        ppalimagesmall.clipsToBounds = true
        ppalimagesmall.layer.borderWidth = 5.0
        ppalimagesmall.layer.borderColor = UIColor.lightGray.cgColor
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath as IndexPath) as! PlaceCollectionViewCell
